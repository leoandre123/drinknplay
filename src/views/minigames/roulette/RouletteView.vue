<template>
  <RetroContainer>
    ...
    <div v-else class="layout">
      <div class="left">
        <button class="rules-button" @click="showRules = true">How to play</button>
        <RouletteRules v-if="showRules" @close="showRules = false" />

        <div class="wheel-area">
          <RouletteWheel ref="wheel" :phase="phase" @spinFinished="onSpinFinished" />
          <button class="spin-button" @click="startSpin" :disabled="phase !== 'betting'">
            {{ $t("roulette.spin") }}
          </button>
          <button
          ...
          <button
            v-else-if="phase === 'result' && round >= maxRounds"
